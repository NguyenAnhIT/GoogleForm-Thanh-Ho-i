    ...
    def handel(self):
        ...
        while True:
            try:
                ...
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[1].send_keys(dataExcel[1])
                sleep(1)
                self.browser.find_element_by_css_selector("textarea.KHxj8b.tL9Q4c").send_keys(dataExcel[2])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[2].send_keys(str(dataExcel[3]))
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[3].send_keys(dataExcel[4])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[4].send_keys(dataExcel[5])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[5].send_keys(dataExcel[6])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[6].send_keys(dataExcel[7])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[7].send_keys(dataExcel[8])
                sleep(1)
                self.browser.find_elements_by_css_selector("textarea.KHxj8b.tL9Q4c")[1].send_keys(dataExcel[9])
                sleep(1)
                self.browser.find_elements_by_css_selector("input.whsOnd.zHQkBf")[8].send_keys(dataExcel[10])
                sleep(1)
                self.browser.find_elements_by_css_selector("textarea.KHxj8b.tL9Q4c")[2].send_keys(dataExcel[11])
                sleep(1)
                #CLick Button
